    ...
    <div class="row">
        ...
        <div class="col-sm-6 col-md-4 mb-4">
            <div class="card border border-0">
                <img src="./images/<?= $prod['imagem']?>" alt="Picanha ao alho" class="card-img-top">
                <div class="card-body bg-dark text-white">
                    <h3 class="card-title"><?= $prod['descricao']?></h3>
                    <p class="fst-italic"><?= $prod['rotulo']?></p>
                    <p class="card-text text-start"><?=mb_strimwidth($prod['resumo'], 0, 79,'...')?></p>
